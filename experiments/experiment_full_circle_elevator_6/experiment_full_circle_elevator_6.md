...
Experiment Date: 14 June 2021, Time: 14:20
## What is the experiment about

As experiment_full_circle_elevator_6


# corresponding branch
experiment_full_circle_elevator_6
...
```
    def _get_observation(self) -> np.array:
        ...
        return np.array([
            ...
            math.sin(math.radians(self.glide_angle_deg)),
            math.cos(math.radians(self.glide_angle_deg)),
            abs(rest_height_ft),
...
```
    def _reward(self):
        ...
        if in_area:
            cross_track_error = self._calc_cross_track_error(aircraft_position, self.target_position)
            vertical_track_error = self._calc_vertical_track_error(aircraft_position, self.target_position) * 2
...
Number of steps:  around 6 Millioms


# Seed
"seed": 4 (Colab)
TD3_guidance-continuous-v0_2021-06-13_14-07-40mi6mts5l

### Example images in the end of training (10)

### Description

checkpoint 4101 performs way better then 6601...
Does not reach more then max 20% during training and does get worse more and more after around 4 M steps.
...
```
std_reward 267.28901654096643
mean_reward -237.07547144262853
at target 0
on tracks 1
headings_sum 1
others_sum 44
...
distances 4.21745563176515
runway_angle_errors (all) 157.32532732721432
success total 2
success 0.02
```
...
```
std_reward 364.0138646263057
mean_reward -203.18227422173925
at target 7
on tracks 21
headings_sum 10
others_sum 43
bounds_sum 50
num total episodes 100
distances 3.534177085853633
runway_angle_errors (all) 121.35939105696438
success total 24
success 0.24
```
...
- Try removing glide angle again from observation --> seems to lead to confusion
- remove heigher weight for vertical error