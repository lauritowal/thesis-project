...
Experiment Date: 23 April 2021, Time: 22:44
## What is the experiment about
Punish the agent for the relative bearing from runway to aircraft difference 
to guide it to the correct area if the aircraft is behind the runway...
...
The aircraft seems to go to the target directly if the aircraft started behind the runway...
