...
Experiment Date: 22 May 2021, Time: 17:45
## What is the experiment about

Run again 3 seeds with reverted branch.
...
```
Only half circle is used: `y = self.np_random.uniform(start_distance, self.max_target_distance_km)`
